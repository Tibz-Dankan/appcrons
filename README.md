...
Integration tests for this project were generated by [TestSprite MCP](https://www.testsprite.com/solutions/mcp), an AI-powered testing agent. TestSprite autonomously analyzed the codebase and produced test cases covering API auth flows, scheduling logic, app enable/disable endpoints, interval boundary edge cases, and time zone handling across two rounds of testing.

All generated test cases are located in the `testsprite_tests/` directory.
...
Create a `.env` file in the root project directory and add all these variables.
